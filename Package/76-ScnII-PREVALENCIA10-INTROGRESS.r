...
ScnII<-read.table("ScnII-PREVALENCIA10.stru",header=TRUE, sep="")
...
ScnII.PREVALENCIA10<-prepare.data(admix.gen=ScnII.HY.gt, 
             loci.data=loci.data,
...
hybrid.index<-est.h(introgress.data=ScnII.PREVALENCIA10, 
                    loci.data=loci.data, 
                    ind.touse=NULL,
                    fixed=FALSE, 
                    p1.allele=NULL, 
...
write.csv(hybrid.index,"ScnII-PREVALENCIA10-hybrid_index.csv")
