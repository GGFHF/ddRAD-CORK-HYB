...
DATA_DIR=PATH_TO_YOUR_DATA_DIRECTORY		# where ScnI-PROGENIES-IMPUTED.vcf and IDs-total.txt file are stored
...
/usr/bin/time \
    ./build-allele-frequency.py \
        ...
        --sp2_id=EN \
        --hyb_id=HY \
        --out=$OUTPUT_DIR/ScnI-PROGENIES-IMPUTED-allelefreq.csv \
        --varnum=1000 \
        --trans=ADD100 \
        --verbose=Y \
        --trace=N \
