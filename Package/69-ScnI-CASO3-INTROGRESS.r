...
ScnI<-read.table("ScnI-CASO3.stru",header=TRUE, sep="")
...
ScnI.CASO3<-prepare.data(admix.gen=ScnI.HY.gt, 
             loci.data=loci.data,
...
hybrid.index<-est.h(introgress.data=ScnI.CASO3, 
                    loci.data=loci.data, 
                    ind.touse=NULL,
                    fixed=FALSE, 
                    p1.allele=NULL, 
...
write.csv(hybrid.index,"ScnI-CASO3-hybrid_index.csv")
