...
DATA_DIR=PATH_TO_YOUR_DATA_DIRECTORY		# where ScnIV-ADULTS-IMPUTED.vcf and IDs-total file are stored
...
/usr/bin/time \
    ./impute-progenies.py \
        --vcf=$DATA_DIR/ScnIV-ADULTS-IMPUTED.vcf \
        ...
        --sp2_id=EN \
        --hyb_id=HY \
        --out=$OUTPUT_DIR/ScnIV-PROGENIES-IMPUTED.vcf \
        --verbose=Y \
        --trace=N \
        --tvi=NONE
