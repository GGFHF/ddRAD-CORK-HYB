...
DATA_DIR=PATH_TO_YOUR_DATA_DIRECTORY		# where simhyb output for ScnIII is stored
...
/usr/bin/time \
    ./simhyb2structure.py \
        --simhyb=$DATA_DIR/ScnIII-SIMHYB-OUTPUT.txt \
        --headernum=2 \
        --structure=$OUTPUT_DIR/ScnIII-SIMHYB-OUTPUT-2LINES.txt \
        --verbose=Y \
        --trace=N
