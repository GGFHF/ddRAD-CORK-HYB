...
DATA_DIR=PATH_TO_YOUR_DATA_DIRECTORY		# where simhyb output for ScnIV is stored
...
/usr/bin/time \
    ./simhyb2structure.py \
        --simhyb=$DATA_DIR/ScnIV-SIMHYB-OUTPUT.txt \
        --headernum=2 \
        --structure=$OUTPUT_DIR/ScnIV-SIMHYB-OUTPUT-2LINES.txt \
        --verbose=Y \
        --trace=N
