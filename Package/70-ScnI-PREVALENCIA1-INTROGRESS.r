...
ScnI<-read.table("ScnI-PREVALENCIA1.stru",header=TRUE, sep="")
...
ScnI.PREVALENCIA1<-prepare.data(admix.gen=ScnI.HY.gt, 
             loci.data=loci.data,
...
hybrid.index<-est.h(introgress.data=ScnI.PREVALENCIA1, 
                    loci.data=loci.data, 
                    ind.touse=NULL,
                    fixed=FALSE, 
                    p1.allele=NULL, 
...
write.csv(hybrid.index,"ScnI-PREVALENCIA1-hybrid_index.csv")
