...
ScnIV<-read.table("ScnIV-PREVALENCIA1.stru",header=TRUE, sep="")
...
ScnIV.PREVALENCIA1<-prepare.data(admix.gen=ScnIV.HY.gt, 
             loci.data=loci.data,
...
hybrid.index<-est.h(introgress.data=ScnIV.PREVALENCIA1, 
                    loci.data=loci.data, 
                    ind.touse=NULL,
                    fixed=FALSE, 
                    p1.allele=NULL, 
...
write.csv(hybrid.index,"ScnIV-PREVALENCIA1-hybrid_index.csv")
