...
ScnIV<-read.table("ScnIV-CASO2.stru",header=TRUE, sep="")
...
ScnIV.CASO2<-prepare.data(admix.gen=ScnIV.HY.gt, 
             loci.data=loci.data,
...
hybrid.index<-est.h(introgress.data=ScnIV.CASO2, 
                    loci.data=loci.data, 
                    ind.touse=NULL,
                    fixed=FALSE, 
                    p1.allele=NULL, 
...
write.csv(hybrid.index,"ScnIV-CASO2-hybrid_index.csv")
