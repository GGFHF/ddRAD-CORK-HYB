...
ScnII<-read.table("ScnII-PREVALENCIA1.stru",header=TRUE, sep="")
...
ScnII.PREVALENCIA1<-prepare.data(admix.gen=ScnII.HY.gt, 
             loci.data=loci.data,
...
hybrid.index<-est.h(introgress.data=ScnII.PREVALENCIA1, 
                    loci.data=loci.data, 
                    ind.touse=NULL,
                    fixed=FALSE, 
                    p1.allele=NULL, 
...
write.csv(hybrid.index,"ScnII-PREVALENCIA1-hybrid_index.csv")
